                            ...
                            <div class="tab-pane" id="tab5">
                                <div class="table-responsive mt-15">
                                    <table class="table center-aligned-table mb-0 table-hover"
                                        ...
                                        <tbody>
                                            <?php $i = 0; ?>
                                            @foreach ($invoice_details as $detailss)
                                                <?php $i++; ?>
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td>{{ $detailss->invoice_number }}</td>
                                                    <td>{{ $detailss->product }}</td>
                                                    <td>{{ $invoices->Section->section_name }}</td>
                                                    @if ($detailss->Value_Status == 1)
                                                        <td><span
                                                                class="badge badge-pill badge-success">{{ $detailss->Status }}</span>
                                                        </td>
                                                    @elseif($detailss->Value_Status == 2)
                                                        <td><span
                                                                class="badge badge-pill badge-danger">{{ $detailss->Status }}</span>
                                                        </td>
                                                    @else
                                                        <td><span
                                                                class="badge badge-pill badge-warning">{{ $detailss->Status }}</span>
                                                        </td>
                                                    @endif
                                                    <td>{{ $detailss->Payment_Date }}</td>
                                                    <td>{{ $detailss->note }}</td>
                                                    <td>{{ $detailss->created_at }}</td>
                                                    <td>{{ $detailss->user }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('delete_file') }}" method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p class="text-center">
                                                                    <h6 style="color:red"> هل انت متأكد من عملية حذف
                                                                        المرفق ؟</h6>
                                                                    </p>
