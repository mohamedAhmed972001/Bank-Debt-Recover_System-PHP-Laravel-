			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/16.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@can('قائمة الفواتير')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمة الفواتير</a></li>
							@endcan
							@can('الفواتير المدفوعة')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='invoices-paid') }}">الفواتير المدفوعة</a></li>
							@endcan
							@can('الفواتير الغير مدفوعة')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='invoices-unpaid') }}">الفواتير الغير مدفوعة</a></li>
							@endcan
							@can('الفواتير المدفوعة جزئيا')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='invoices-partially') }}">الفواتير المدفوعة جزئياََ</a></li>
							@endcan
							@can('ارشيف الفواتير')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='invoices-archive') }}">ارشيف الفواتير</a></li>
							@endcan
						</ul>
					</li>
					@endcan

					@can('التقارير')		<!-- permissions -->				
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@can('قائمة المستخدمين')		<!-- permissions -->				
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المستخدمين</a></li>
							@endcan
							@can('صلاحيات المستخدمين')		<!-- permissions -->				
