						...
						<div class="card">
							...
							<div class="card-body pd-y-7">
								...
								<div class="wrapper d-flex justify-content-center image-group pb-3">
									...
									<img src="{{URL::asset('assets/img/faces/116.png')}}" alt="profile" class="img-xs rounded-circle">
								</div>
							</div><!-- card-body -->
						</div>
					</div>
							...
							<div class="card-body">
								...
								<ul class="list list-noborders pb-0 mb-0">
									...
									<li class="list-item">
										...
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/016.png')}}" alt="thumb images">
