							...
							<div class="main-content-left main-content-left-chat">
								...
								<div class="main-chat-contacts-wrapper">
									...
									<div class="main-chat-contacts" id="chatActiveContacts">
										...
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/16.png')}}"></div><small>George</small>
										</div>
										<div>
								...
								<div class="main-chat-list" id="ChatList">
									...
									<div class="media new">
										<div class="main-img-user">
											<img alt="" src="{{URL::asset('assets/img/faces/16.png')}}"> <span>1</span>
										</div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media border-bottom-0">
										<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/16.png')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
							...
							<div class="main-content-body main-content-body-chat">
								...
								<div class="main-chat-body" id="ChatBody">
									<div class="content-inner">
										...
										<div class="media">
											<div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/16.png')}}"></div>
											<div class="media-body">
