								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{URL::asset('assets/img/faces/16.png')}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									...
									<div class="tab-pane" id="profile">
										<div class="row">
											...
											<div class="col-sm-4">
												<div class=" border p-1 card thumb  mb-xl-0">
													<a href="#" class="image-popup" title="Screenshot-2"> <img src="{{URL::asset('assets/img/photos/16.png')}}" class="thumb-img" alt="work-thumbnail"> </a>
													<h4 class="text-center tx-14 mt-3 mb-0">Gallary Image</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>Photography</small></p>
												</div>
