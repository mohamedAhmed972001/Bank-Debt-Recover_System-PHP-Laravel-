                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- زر التعديل -->
                                            <a class="modal-effect btn btn-square btn-primary btn-sm"
                                            ...
                                            <!-- زر الحذف -->
                                            <a class="modal-effect btn btn-square btn-danger btn-sm"
                                                data-effect="effect-scale" data-id="{{ $product->id }}"
                        ...
                        <form action="{{ route('products.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="section_id" name="section_id">
                                    <option value="" disabled selected>حدد قسم</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="products/update" method="post" autocomplete="off">
                            {{ method_field('patch') }}
                            {{ csrf_field() }} <!-- لأنك تقوم بتحديث حقل واحد أو جزء من البيانات -->
                            <div class="form-group">
