        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio"  value="1" type="radio" id="type_div"><span>
                                بحث بنوع الفاتورة
                            </span>
                        </label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox">
                            <input name="rdio" value="2" type="radio"><span>
                                بحث برقم الفاتورة
                            </span>
                        </label>
                    </div><br><br>
                    ...
                    <div class="row">
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="FormSearchByNumber">
                            <p class="mg-b-10">البحث برقم الفاتورة</p>
                            <input type="text" class="form-control" id="invoice_number" name="invoice_number" >
                        </div><!-- col-4 -->
                            
                        <div class="row" id="FormSearchByType">
...
<script>
    $(document).ready(function() {
        ...
        $('#FormSearchByNumber').hide();

        $('input[type="radio"]').click(function() {
            if ($(this).attr('id') == 'type_div') {
                $('#FormSearchByNumber').hide();
                $('#FormSearchByType').show();
            } else {
                $('#FormSearchByNumber').show();
                $('#FormSearchByType').hide();
            }
        });
    });
