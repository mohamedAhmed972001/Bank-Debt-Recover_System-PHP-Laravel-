								...
								<div class="main-content-app main-content-contacts pt-0">
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="{{URL::asset('assets/img/faces/16.png')}}"></div>
												<div class="main-contact-body">
								...
								<div class="main-contact-info-header pt-3">
									<div class="media">
										<div class="main-img-user">
											<img alt="avatar" src="{{URL::asset('assets/img/faces/16.png')}}"> <a href=""><i class="fe fe-camera"></i></a>
										</div>
