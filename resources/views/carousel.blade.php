								...
								<div>
									<div class="carousel slide" data-ride="carousel" id="carouselExample3">
										...
										<div class="carousel-inner">
											...
											<div class="carousel-item">
												<img alt="img" class="d-block w-100" src="{{URL::asset('assets/img/photos/116.png')}}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="carousel-slider">
									<div id="carousel" class="carousel slide" data-ride="carousel">
										<div class="carousel-inner">
											...
											<div class="carousel-item"> <img src="{{URL::asset('assets/img/photos/16.png')}}" alt="img"> </div>
										...
										<div id="thumbcarousel" class="carousel slide" data-interval="false">
											<div class="carousel-inner">
												...
												<div class="carousel-item">
													...
													<div data-target="#carousel" data-slide-to="5" class="thumb"><img src="{{URL::asset('assets/img/photos/16.png')}}" alt="img"></div>
							...
							<div class="card-body ht-100p">
								...
								<div id="basicSlider">
									<div class="MS-content">
										...
										<div class="item">
											<a href="#" target="_blank"> <img src="{{URL::asset('assets/img/photos/16.png')}}" alt="" /> </a>
										</div>
										<div class="item">
