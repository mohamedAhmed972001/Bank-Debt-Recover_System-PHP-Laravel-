...
@section('content')
				...
				<div class="demo-gallery">
					<ul id="lightgallery" class="list-unstyled row row-sm pr-0">
						...
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/photos/16.png')}}" data-src="{{URL::asset('assets/img/photos/16.png')}}" data-sub-html="<h4>Gallery Image 6</h4>" >
							<a href="">
								<img class="img-responsive" src="{{URL::asset('assets/img/photos/16.png')}}" alt="Thumb-1">
							</a>
						</li>
